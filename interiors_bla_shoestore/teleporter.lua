...
-----------------------------------------------------
RegisterCommand("takemeto_interiors_bla_shoestore", function(source, args)    
    if args ~= nil then   
        local data =  source 
        local ped = PlayerPedId() 
        local coords = GetEntityCoords(ped)        
        if Config.TeleportME == true then 
            TriggerEvent( "interiors_bla_shoestore:scottybeammeup", Config.x, Config.y, Config.z )
        else 
...
RegisterNetEvent('interiors_bla_shoestore:scottybeammeup')
AddEventHandler('interiors_bla_shoestore:scottybeammeup', function(x,y,z)  
