...
Config.Label = "interiors_bla_shoestore"
Config.x = -846.36
Config.y = -1321.8
Config.z = 43.14    
...
sets = {
    {name = "bla_shoestore", type="ydr", engage=true, desc=""}, 
    {name = "bla_shoestore_decal", type="ydr", engage=true, desc=""},
    {name = "bla_shoestore_det", type="ydr", engage=true, desc=""},
    {name = "bla_shoestore_em", type="ydr", engage=true, desc=""}, 
    {name = "bla_shoestore+hidr", type="ytd", engage=true, desc=""}, 
} 