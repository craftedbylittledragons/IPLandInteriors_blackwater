...
function DisableResourcesINTERIORS(x, y, z)   
    ...
    DeactivateInteriorEntitySet(interior, "_saltedmeats_dressing")
    ...
    DeactivateInteriorEntitySet(interior, "_s_inv_CocaineGum01x_dressing")
    DeactivateInteriorEntitySet(interior, "_s_inv_CocaineGum01x_group")
